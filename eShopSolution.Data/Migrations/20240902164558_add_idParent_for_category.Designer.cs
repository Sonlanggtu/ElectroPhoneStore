...
namespace eShopSolution.Data.Migrations
{
    ...
    [Migration("20240902164558_add_idParent_for_category")]
    partial class add_idParent_for_category
    {
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "cf62ec38-8acf-4333-af84-27eca2ed3318",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "ABCDXYZ",
                            ConcurrencyStamp = "16ab9242-bcd6-4b41-9910-ea90b5b48f74",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELUYgas6GGlZzx8DIE3lyQ+eqXbv1JFqL3kJB6qghKfZG/Nq8n9lppxhH26D1v9/dg==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 465, DateTimeKind.Local).AddTicks(7020),
                            Description = "",
                            Details = "",
                            Name = "iPhone 12 Pro",
                            Price = 28890000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 466, DateTimeKind.Local).AddTicks(3979),
                            Description = "",
                            Details = "",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 466, DateTimeKind.Local).AddTicks(4009),
                            Description = "",
                            Details = "",
                            Name = "Oppo Reno 5",
                            Price = 8290000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 466, DateTimeKind.Local).AddTicks(4011),
                            Description = "",
                            Details = "",
                            Name = "Vivo V21 5G",
                            Price = 9990000m,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 5,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 466, DateTimeKind.Local).AddTicks(4013),
                            Description = "",
                            Details = "",
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 6,
                            DateCreated = new DateTime(2024, 9, 2, 23, 45, 58, 466, DateTimeKind.Local).AddTicks(4014),
                            Description = "",
                            Details = "",
                            Name = "Nokia 5.4",
                            Price = 3290000m,
